...
func (in *CELCostMetrics) DeepCopyInto(out *CELCostMetrics) {
	*out = *in
	if in.TotalCost != nil {
	...
	if in.CostPerResource != nil {
		in, out := &in.CostPerResource, &out.CostPerResource
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CELCostMetrics.
func (in *CELCostMetrics) DeepCopy() *CELCostMetrics {
	if in == nil {
		return nil
	}
	out := new(CELCostMetrics)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ResourceGraphDefinitionStatus) DeepCopyInto(out *ResourceGraphDefinitionStatus) {
	*out = *in
	...
	if in.CELMetrics != nil {
		in, out := &in.CELMetrics, &out.CELMetrics
		*out = new(CELCostMetrics)
		(*in).DeepCopyInto(*out)
	}
}
